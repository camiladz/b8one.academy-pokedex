...
async function fetchPokemons() {
    const response = await fetch("https://pokeapi.co/api/v2/pokemon?limit=70&offset=1");
                ...
                <ul class="pokemons-card-atributes">
                    <li class="pokemons-card-atributes-item">
                        ...
                        <div class="pokemons-card-atributes-progress">
                            <div class="pokemons-card-atributes-progress-bar" style="width: ${hpStat.base_stat}%"></div>
                        </div>
                    </li>
                    <li class="pokemons-card-atributes-item">
                        <span class="pokemons-card-atributes-name">
                        ...
                        <div class="pokemons-card-atributes-progress">
                            <div class="pokemons-card-atributes-progress-bar" style="width: ${attackStat.base_stat}%"></div>
                        </div>
                    </li>
                    <li class="pokemons-card-atributes-item">
                        <span class="pokemons-card-atributes-name">
                        ...
                        <div class="pokemons-card-atributes-progress">
                            <div class="pokemons-card-atributes-progress-bar" style="width: ${defenseStat.base_stat}%"></div>
                        </div>
                    </li>
                    <li class="pokemons-card-atributes-item">
                        <span class="pokemons-card-atributes-name">
                        ...
                        <div class="pokemons-card-atributes-progress">
                            <div class="pokemons-card-atributes-progress-bar" style="width: ${specialAttackStat.base_stat}%"></div>
                        </div>
                    </li>
                </ul>
            </div>
...
async function filterClicked(filter, pokemonsData) {
    ...
    const pokemonsDataFiltredByType = pokemonsData.filter(pokemonsData => {
    ...
    if (pokemonType === "all") {
        ...
        for (const pokemon of pokemonsDataFiltredByType) {
            insertPokemonHtml(pokemon)
        }
    }
